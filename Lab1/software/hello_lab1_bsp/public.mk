...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nios2_systems.sopcinfo
...
# Design Name 
# setting SOPC_NAME is nios2_systems
SOPC_NAME := nios2_systems
...
# setting hal.stderr is jta_uart
ELF_PATCH_FLAG  += --stderr_dev jta_uart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jta_uart
ELF_PATCH_FLAG  += --stdin_dev jta_uart
...
# setting hal.stdout is jta_uart
ELF_PATCH_FLAG  += --stdout_dev jta_uart
